...
### **2025 KI-IT Summar Paper Competition Published**
<br>[**An Approach to build MCP-based Personal Voice Assistant on PC**](https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE12288718)</br>
Basic PC-powered mostly used use cases empowered by agentic ai system.
<br>But it's for entertainment & repetitive tasks for users.
<br>Not for a business assistant.

<br>**Patent being Applied**
<br>Patent No. 10-2025-0165376
<br>**ARTIFICIAL INTELLIGENCEBASED COMMAND CODE GENERATION SOLUTION USING VOICE COMMANDS**
...
---
📚 **Department of Software Engineering** @ JBNU (4th grade, 2025)  
Undergrade Researcher @ Statistics Lab - GLAMP of JBNU

- Ongoing Researches
  - System Architecture for Disease Diagnosis of Medical Field
    - Mostly for time series-based inference
  - Reproducibility of AI Models of Medical Field

- Past Researches
  - Survey research for Physical AI Poc's SDF-OCS Development
